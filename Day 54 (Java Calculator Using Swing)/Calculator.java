    ...
    Calculator(){
        ...
        b1.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                l2.setText("Sum of Two Number is: "+(no1+no2));
        ...
        b2.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent ae) {
                int no1=Integer.parseInt(t1.getText());
                int no2=Integer.parseInt(t2.getText());
                l2.setText("Subtraction of Two Number is: "+(no1-no2));
        ...
        b3.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent ae) {
                int no1=Integer.parseInt(t1.getText());
                int no2=Integer.parseInt(t2.getText());
                l2.setText("Multiplication of Two Number is: "+(no1*no2));
        ...
        b4.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent ae) {
                int no1=Integer.parseInt(t1.getText());
                int no2=Integer.parseInt(t2.getText());
                l2.setText("Division of Two Number is: "+(no1/no2));
